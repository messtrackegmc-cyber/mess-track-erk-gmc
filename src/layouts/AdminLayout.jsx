...
import { Bell, LayoutDashboard, UtensilsCrossed, Users, Menu, FileSpreadsheet, Settings, CalendarCheck, Calendar, IndianRupee, CalendarClock, Activity } from 'lucide-react';
            ...
            <div className="flex-1 flex flex-col min-h-screen">
                ...
                <header className="sticky top-0 z-40 bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between shadow-sm">
                    <div className="flex items-center gap-4 lg:hidden">
                        ...
                        <h2 className="text-lg font-semibold text-gray-800">Mess Track-E Admin</h2>
                    </div>
